  ...
  return (
    <nav className="navbar glass">
      ...
      <Link to="/" className="navbar-brand">
        ...
        <span className="brand-name">Arsenal Tools</span>
      </Link>
      ...
      {pathname === '/circuit-simulator' && (
        <div className="navbar-circuit-actions">
          ...
          <button
            type="button"
            className="btn btn-ghost navbar-sim-icon-btn"
            onClick={() => window.dispatchEvent(new CustomEvent('open-circuit-help-modal'))}
          ...
          <button
            type="button"
            className="btn btn-ghost navbar-sim-icon-btn"
            onClick={() => window.dispatchEvent(new CustomEvent('toggle-circuit-fullscreen'))}
      ...
      {/* Mobile hamburger */}
      <button className="mobile-menu-btn btn-ghost" aria-label="Menu">
